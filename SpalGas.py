...
# Form implementation generated from reading ui file 'SpalGas_v3.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButtonCalculate.clicked.connect(MainWindow.calculateButtonClicked)
        self.pushButton_Lambda.clicked.connect(MainWindow.lambdaButtonClicked)
        self.pushButtonEval_in.clicked.connect(MainWindow.evalInButtonClicked)
        self.actionClose.triggered.connect(MainWindow.close)
        self.pushButtonSpecies.clicked.connect(MainWindow.speciesButtonClicked)
        self.pushButtonSetNG.clicked.connect(MainWindow.NGButtonClicked)
        self.pushButtonSetAir.clicked.connect(MainWindow.airButtonClicked)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)
        MainWindow.setTabOrder(self.lineEdit_T_in, self.lineEdit_Flow_in)
        MainWindow.setTabOrder(self.lineEdit_Flow_in, self.lineEdit_P_in)
        MainWindow.setTabOrder(self.lineEdit_P_in, self.lineEdit_RH_in)
        MainWindow.setTabOrder(self.lineEdit_RH_in, self.checkBox_VolFr_in)
        MainWindow.setTabOrder(self.checkBox_VolFr_in, self.tableWidget_In1)
        MainWindow.setTabOrder(self.tableWidget_In1, self.plainTextEdit_Stream1_out)
        MainWindow.setTabOrder(self.plainTextEdit_Stream1_out, self.lineEdit_2)
        MainWindow.setTabOrder(self.lineEdit_2, self.pushButton_Lambda)
        MainWindow.setTabOrder(self.pushButton_Lambda, self.lineEdit_3)
        MainWindow.setTabOrder(self.lineEdit_3, self.pushButtonEval_in)
        MainWindow.setTabOrder(self.pushButtonEval_in, self.lineEdit_tepl)
        MainWindow.setTabOrder(self.lineEdit_tepl, self.lineEdit_mf)
        MainWindow.setTabOrder(self.lineEdit_mf, self.lineEdit_Vf)
        MainWindow.setTabOrder(self.lineEdit_Vf, self.lineEdit_VfN)
        MainWindow.setTabOrder(self.lineEdit_VfN, self.lineEdit_density)
        MainWindow.setTabOrder(self.lineEdit_density, self.lineEdit_visc)
        MainWindow.setTabOrder(self.lineEdit_visc, self.lineEdit_cp)
        MainWindow.setTabOrder(self.lineEdit_cp, self.tabWidget)
        MainWindow.setTabOrder(self.tabWidget, self.tableWidget_Real)
        MainWindow.setTabOrder(self.tableWidget_Real, self.pushButtonCalculate)
        MainWindow.setTabOrder(self.pushButtonCalculate, self.comboBoxFlow1)
        MainWindow.setTabOrder(self.comboBoxFlow1, self.tableWidget_Dry)
        MainWindow.setTabOrder(self.tableWidget_Dry, self.tableWidget_RefO2)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "GasComb"))
